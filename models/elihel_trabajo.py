...
class Elihel_Trabajos(models.Model):
    ...
    lyd = fields.Integer(string="Limpieza y Desinfeccion", help="Limpieza y Desinfeccion")
    ...
    crm = fields.Integer(string="Contenedores Redes Materiales", help="Contenedores Redes Materiales")
    rfr = fields.Integer(string="Reefer", help="Reefer")
    eee = fields.Integer(string="Estanque ensilaje y equipos", help="Estanque ensilaje y equipos")
